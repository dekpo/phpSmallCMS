...
if (!empty($_POST)) {
    writeAllTxt("../assets/home/content.txt", $_POST["parag"]);
}
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1><a href="./">Admin</a> &gt; Home</h1>
            </div>
        </div>
        <div class="row p-3">
        <h2>Here is your home parag</h2>
            <div class="col-12 border">
                <form action="" method="POST">
                <div class="form-group">
                <label for="parag">Paragraphe</label>
                    <textarea class="form-control" id="parag" name="parag" rows="8" style="width:100%"><?= readAllTxt("../assets/home/content.txt") ?></textarea>
                </div>
